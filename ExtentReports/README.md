# [Atata Samples](https://github.com/atata-framework/atata-samples) / ExtentReports
...
Demonstrates the Atata reporting using [ExtentReports](https://github.com/extent-framework/extentreports-csharp) .NET library.
